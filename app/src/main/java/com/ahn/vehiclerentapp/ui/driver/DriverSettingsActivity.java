...
public class DriverSettingsActivity extends AppCompatActivity {
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot querySnapshot) {
                        ...
                        if (cityDataList.get(0).getArrayList() != null) {
                            ...
                            ArrayAdapter<String> adapter = new ArrayAdapter<>(DriverSettingsActivity.this, android.R.layout.simple_spinner_dropdown_item, cities);
                            et_nearest_town.setAdapter(adapter);

                            for (int x=0; x < cityDataLists.size(); x++){
                                if (cityDataLists.get(x).getCity_name().equalsIgnoreCase(driverDetails.getActive_town())){
    ...
    private void showAlert(int type) {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(DriverSettingsActivity.this);
