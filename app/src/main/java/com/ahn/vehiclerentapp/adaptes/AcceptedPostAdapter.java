...
public class AcceptedPostAdapter extends BaseAdapter {
    ...
    public AcceptedPostAdapter(Context context, ArrayList<PostsDataList> postsDataLists, ItemClickListenerAccList itemClickListener) {
    ...
    public View getView(int position, View contentView, ViewGroup parent) {
        ...
        if (contentView == null) {
            ...
            contentView = inflater.inflate(R.layout.item_post_accept, parent, false);
        }
        ...
        tv_call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                itemClickListener.onItemClickAccept(position, postsDataLists.get(position), phone);
            }
        });
    ...
    public interface ItemClickListenerAccList{
        void onItemClickAccept(int position, PostsDataList postsDataLists, String phone);
    }
}
